        ...
        <div className="flex flex-col gap-[13px] items-center justify-start max-w-[1648px] mb-5 mt-0.5 mx-auto md:px-5 w-full">
          ...
          <div className="flex md:flex-col flex-row gap-[23px] items-center justify-between w-full">
            ...
            <div className="bg-gray-50_a8 flex md:flex-1 flex-col items-center justify-end mb-0.5 p-[29px] sm:px-5 rounded-[30px] w-4/5 md:w-full">
              <div className="flex md:flex-col flex-row font-montserrat gap-[55px] items-start justify-start mt-[5px] w-auto md:w-full">
                ...
                <List
                  className="sm:flex-col flex-row md:gap-10 gap-[207px] grid md:grid-cols-1 grid-cols-2 justify-center w-auto md:w-full"
                ...
                >
                  <div className="flex flex-col gap-3.5 items-start justify-start w-auto">
                    <div className="flex flex-col gap-3.5 items-start justify-start w-auto">
                      ...
                      <Text
                        className="capitalize sm:text-2xl md:text-[26px] text-[28px] text-indigo-900"
                      ...
                      <Text
                        className="max-w-[260px] md:max-w-full text-base text-black-900"
                        size="txtSignikaNegativeRegular16Black900"
                      >
                        Get people with aleast 1,000 followers to post your
                        adverts and perform social engagement tasks for you on
                        their social media account.
                      </Text>
                    </div>
                    <Button
                      className="!text-white-A700 cursor-pointer leading-[normal] min-w-[197px] text-center text-xl"
                      shape="round"
                      color="indigo_900"
                      size="sm"
                      variant="fill"
                  ...
                  <div className="flex flex-col gap-3.5 items-start justify-start w-auto">
                    <div className="flex flex-col gap-3.5 items-start justify-start w-auto">
                      ...
                      <Text
                        ...
                        size="txtSignikaNegativeRegular16Black900"
                      >
                        Earn steady income by reselling products and posting
                        adverts and performing social tasks for businesses and
                        top brands on your social media account.
                      </Text>
                    </div>
                    <Button
                      className="!text-white-A700 cursor-pointer leading-[normal] min-w-[197px] text-center text-xl"
              ...
              <div className="bg-white-A700 flex flex-col font-montserrat gap-[33px] h-[582px] md:h-auto items-start justify-start mt-[57px] sm:px-5 px-[31px] py-[30px] rounded-[30px] w-auto md:w-full">
              ...
              <Text
                className="mt-[27px] text-indigo-900 text-sm"
